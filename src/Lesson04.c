...
* \version         2.0.1.0
* \date            5 février 2023
* \brief           Ouvre une simple fenêtre Windows et dessine deux formes avec OpenGL : un triangle et un carré colorés avec une rotation lente.
...
* \return     int                un entier (OK ou non).
*
*/
